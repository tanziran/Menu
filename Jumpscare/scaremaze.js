...
$(document).ready(function() {
    ...
    $("#finish").mouseover(function() {
        if (stat == "go") {
            // Level +
            var levelID = $("#maze").attr("class");
            levelID = Number(levelID[levelID.length - 1]) + 1;
            console.log(levelID);
            $("#maze").removeClass();
    ...
    $(".scarehere").mouseover(function() {
        if (stat == "go") {
            ...
            stat = "start";
            $("body").addClass("scare");
            var screamsound = document.getElementById("audioplayer");
            screamsound.play();
            setTimeout(function() {
                palyaReset();
            }, 3000);
...
function palyaReset() {
    $("#maze").removeClass();
    $("#maze").addClass("level1 normalcursor");
    $("#level").text("Level 1");
    $("#start").fadeIn(50);
    stat = "start";
    $("#start").text("Start").removeClass("go");
    $("body").removeClass("scare");
}
/*
setTimeout(function () {
